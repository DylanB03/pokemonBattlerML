...
from pokemon_battler.core.actions import ACTION_COUNT, action_label, legal_action_ids
from pokemon_battler.core.mechanics import MECHANICS_SCHEMA as LEGACY_MECHANICS_SCHEMA
from pokemon_battler.core.mechanics_v2 import MECHANICS_SCHEMA as DEFAULT_MECHANICS_SCHEMA
from pokemon_battler.core.observations import canonicalize_observation
from pokemon_battler.core.prompting import encode_candidate_prompt, render_prompt
...
class MechanicsCollator:
    ...
    def _encode(
        ...
        if self.mechanics_schema == DEFAULT_MECHANICS_SCHEMA:
            from pokemon_battler.core.mechanics_v2 import candidate_identity_matrix
...
class InteractionCollator:
    ...
    def _encode_observation(
        ...
        *,
        ...
        from pokemon_battler.models.interaction_features import (
