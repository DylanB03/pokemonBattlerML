...
from pokemon_battler.showdown.external_opponents import ExternalOpponentProcess
from pokemon_battler.showdown.live_eval import DEFAULT_TEAM, _wilson_interval
...
from pokemon_battler.showdown.poke_env_compat import (
